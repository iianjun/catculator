...
2. **splash-icon.png** - Pixel cat with calculator, 1024x1024
   - WHERE USED: App launch screen

3. **cat-neutral.png** - Neutral pixel cat (128x128)
   - WHERE USED: Home screen default state

4. **cat-happy.png** - Happy pixel cat (128x128)
   - WHERE USED: Results screen, successful calculation

5. **cat-worried.png** - Worried pixel cat (128x128)
   - WHERE USED: Obese-prone warning state

6. **food-bowl.png** - Pixel art cat food bowl (64x64)
   - WHERE USED: Food Details screen, portion display

7. **avatar-cat1.png through avatar-cat4.png** - 4 distinct pixel cat avatars (64x64 each)
   - WHERE USED: Settings screen avatar selector
